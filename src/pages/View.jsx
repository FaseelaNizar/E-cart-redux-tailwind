      ...
      <div className='flex flex-col mx-5'>
        <div className='grid grid-cols-2 items-center h-screen'>
          ...
          <div>
            ...
            <p>
              <span className='font-bold'>Description</span>: Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam harum, vitae, quo architecto adipisci non molestiae enim quibusdam tempora necessitatibus numquam exercitationem eligendi, recusandae aspernatur eius animi id doloribus omnis.
