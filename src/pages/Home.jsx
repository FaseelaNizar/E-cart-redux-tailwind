...
const Home = () => {
  ...
  const currentPageProductFastIndex = currentPageProductLastIndex - productPerPage
  const visibleAllProducts = allProducts?.slice(currentPageProductFastIndex, currentPageProductLastIndex)
